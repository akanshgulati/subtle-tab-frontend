<template>
    <div v-on:click.stop="" @mousedown.stop="" class="flex flex-flow-column">
                ...
                <div class="close-btn" v-on:click="closeCustomizeMenu">
                    <svg width="1.5em" height="1.5em" viewBox="0 0 12 12">
                        <g stroke="none" stroke-width="1" fill="none"
                           fill-rule="evenodd">
                            <g id="close_btn" fill-rule="nonzero"
                               fill="#5C5C5C">
                                <path
                                    d="M6,0 C2.69169231,0 0,2.69146154 0,6 C0,9.30853846 2.69169231,12 6,12 C9.30830769,12 12,9.30853846 12,6 C12,2.69146154 9.30830769,0 6,0 Z M6,11.5384615 C2.94623077,11.5384615 0.461538462,9.05376923 0.461538462,6 C0.461538462,2.94623077 2.94623077,0.461538462 6,0.461538462 C9.05376923,0.461538462 11.5384615,2.94623077 11.5384615,6 C11.5384615,9.05376923 9.05376923,11.5384615 6,11.5384615 Z"></path>
                                <path
        ...
        <footer
            class="customize-footer font-xsmall flex flex-justify-space-between bg-light-grey">
            <div class="flex">
        ...
        <svg style="display: none;">
            <defs>
                <g id="icon-general">
                    ...
                    <path
                        d="M20.56047,16.1486849 L12.76254,16.1486849 C12.8072367,16.1486849 12.84254,16.1841125 12.84254,16.2272053 C12.84254,16.2702982 12.8072367,16.3057258 12.76254,16.3057258 L20.56047,16.3057258 C20.5157733,16.3057258 20.48047,16.2702982 20.48047,16.2272053 C20.48047,16.1842238 20.5158719,16.1486849 20.56047,16.1486849 Z"></path>
                    <path
                ...
                <g id="icon-clock">
                    <circle id="Oval" cx="10.5" cy="10.5"
                            r="9.13133536"></circle>
                    <polyline id="Shape"
                              transform="translate(10.842248, 8.898166) rotate(-51.000000) translate(-10.842248, -8.898166) "
                              points="6.49624149 8.22774104 9.10632618 11.3606903 15.1882544 6.43564197"></polyline>
                </g>
                <g id="icon-wallpaper">
                    <polyline id="Shape"
                              points="0.00857797986 14.8245426 5.23298105 8.6542509 11.1104345 15.595829"></polyline>
                    <polyline id="Shape"
                              points="8.11946374 11.4834513 14.158003 0.170099836 20.8539462 12.7060758"></polyline>
                    <ellipse id="Oval" cx="6.9321391" cy="3.82227375"
                             rx="1.95915115" ry="1.91656091"></ellipse>
                </g>
                <g id="icon-weather">
                    <path
                    ...
                    <path
                        d="M9.80542145,5.63278522 C8.77103491,6.30623519 8.00383292,7.38143781 7.70409726,8.64561097 C7.56564838,8.62366506 7.42393017,8.62027743 7.28055362,8.62027743 C6.32439401,8.62027743 5.47408479,9.089488 4.93000249,9.81699267 C3.83861596,9.2211635 3.09420449,8.03628039 3.09420449,6.6691038 C3.09420449,4.70609804 4.63031421,3.11445449 6.52472319,3.11445449 C8.07225187,3.11445449 9.37865586,4.17448644 9.80542145,5.63278522 Z"></path>
                    <path d="M6.46,0 L6.46,1.86564838"></path>
                    <path d="M0,6.69375 L1.80049875,6.69375"></path>
                    <path
                        d="M9.74268828,3.39602011 L11.065818,2.02501403"></path>
                    <path
                        d="M1.79016958,11.3939565 L3.11329925,10.0229504"></path>
                    <path
                        d="M1.79016958,2.02501403 L3.11329925,3.39602011"></path>
                </g>
                <g id="icon-whatsnew">
                    <path
                    ...
                    <circle fill-rule="nonzero" cx="6.86892358" cy="9.03592685"
                            r="1"></circle>
                    <circle fill-rule="nonzero" cx="10.4069865" cy="9.03592685"
                            r="1"></circle>
    ...
    export default {
        ...
        mounted() {
            ...
            this.customLocation = this.settings.weather.location.name ||
                (storage.get(constants.STORAGE.WEATHER) &&
                    storage.get(constants.STORAGE.WEATHER)['city'])
        ...
        methods: {
            ...
            saveCustomBg() {
                let validateImgUrls = (backgrounds) => {
                    for (let i = 0; i < backgrounds.length; i++) {
                        if (backgrounds[i].match(
                            /^(http?|https):\/\/.*(jpeg|png|gif|bmp|jpg)/g) ===
                            null) {
                ...
                if (this.currentBgCustom) {
                    ...
                    if (backgrounds && backgrounds.length &&
                        validateImgUrls(backgrounds)) {
                        backgrounds = cleanUrls(backgrounds)
                        storage.set(constants.STORAGE.BACKGROUND_CUSTOM,
                            backgrounds)
            ...
            calendarAuthSuccess() {
                ...
                storage.set(constants.STORAGE.G_CAL_AUTH,
