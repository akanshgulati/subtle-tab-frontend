<template>
    <div>
        ...
        <customize :settings="sharedData" id="customize" :class="{ 'fade_in': showCustomizeMenu}" v-on:closeCustomizeMenu="toggleCustomizeMenu"></customize>
    </div>
</template>
