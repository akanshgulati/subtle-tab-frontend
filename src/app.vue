                        ...
                        <div class="flex flex-center">
                            <div class="notes-widget relative" v-on:keydown.stop=""  v-if="sharedData.showUtilities.showNotes">
                                <div class="notes-icon pointer" v-on:click.stop="showNotes = !showNotes">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 58.27 58.27" style="enable-background:new 0 0 58.27 58.27;" xml:space="preserve" width="1.8em" >
                                        <g id="note_btn">
                            ...
                            <div class="pointer nav-bar-opener relative" v-on:click.stop="toggleCustomizeMenu">
                                <svg enable-background="new 0 0 20 20" height="2em" version="1.1" viewBox="0 0 100 100" width="2em" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                    <g id="customize_btn">
