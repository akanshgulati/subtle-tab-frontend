    ...
    <div v-on:click="closeWindows">
        ...
        <div v-if="seenOnBoarding">
            ...
            <div id="viewport" :class="{'fade_in': !isLoading}">
                <background :settings="componentsData.background" v-on:stopLoading="stopLoad"
                ...
                <div id="utilities">
                    ...
                    <div id="position--top-right">
                        <div class="flex flex-center">
                            <div class="todo-widget relative" v-on:keydown.stop="">
                                <div class="todo-icon pointer" v-on:click.stop="toggleTodos">
                                    <svg xmlns="http://www.w3.org/2000/svg" version="1.1" viewBox="0 0 512 512"
                                         enable-background="new 0 0 512 512" width="1.8rem">
                                        <g>
                                            <g id="todo_btn">
                            ...
                            <div class="pointer nav-bar-opener" v-on:click.stop="toggleCustomizeMenu"
                                 :class="{'fade_in': !showCustomizeMenu}">
                    ...
                    <div id="position--top-left">
                        <weather :settings="componentsData.weather"
                                 v-if="sharedData.showUtilities.showWeather"></weather>
                    </div>
                </div>
            </div>
