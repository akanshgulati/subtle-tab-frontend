<template>
    <div>
        ...
        <div v-if="seenOnBoarding">
                    ...
                    <div id="position--top-right">
                        <div class="flex flex-center">
                            <div class="notes-widget">
                                <div class="notes-icon pointer" v-on:click="toggleNotes">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" x="0px" y="0px" viewBox="0 0 58.27 58.27" style="enable-background:new 0 0 58.27 58.27;" xml:space="preserve" width="1.7rem" >
                                        <g id="note_btn">
            ...
            <div class="customization-overlay" v-if="showCustomizeMenu"></div>
