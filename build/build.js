...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_clock_vue__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_customize_vue__ = __webpack_require__(16);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_bgUtil__ = __webpack_require__(9);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_backgroundData__ = __webpack_require__(0);
//
//
//
//
...
var backgroundVue = {
    ...
    methods: {
        getBackgroundURL: function getBackgroundURL(reset) {
            ...
            var localBgData = localStorage.getItem('bgData') && JSON.parse(localStorage.getItem('bgData'));
            var theme = __WEBPACK_IMPORTED_MODULE_1__utils_backgroundData__["a" /* default */].getCurrentTheme(this.settings.themeId);
            ...
            if (navigator.onLine) {
                (function () {
                    ...
                    if (!localBgData && self.tabsCount < 25 || reset) {
                        __WEBPACK_IMPORTED_MODULE_0__utils_bgUtil__["a" /* default */].getWallpaper(theme.value, function (bgData) {
                            bgData = __WEBPACK_IMPORTED_MODULE_0__utils_bgUtil__["a" /* default */].getFormattedJSON(bgData);
...
// module
exports.push([module.i, "\n.time, .date{\n    color: rgba(242, 242, 242, 0.9);\n}\n.time{\n    font-size: 12rem;\n    font-weight: 500;\n    line-height: 12rem;\n}\n.date{\n    opacity: 0;\n    font-size: 3.5rem;\n    font-weight: 900;\n    line-height: 4rem;\n    text-align: center;\n}\n", "", {"version":3,"sources":["/./src/components/clock.vue?25a896a4"],"names":[],"mappings":";AAoDA;IACA,gCAAA;CACA;AACA;IACA,iBAAA;IACA,iBAAA;IACA,mBAAA;CACA;AACA;IACA,WAAA;IACA,kBAAA;IACA,iBAAA;IACA,kBAAA;IACA,mBAAA;CACA","file":"clock.vue","sourcesContent":["<template>\n    <div id=\"clock\">\n        <div class=\"time\">{{hrs}}:{{min}}</div>\n        <div class=\"date\" v-bind:class=\"{'fade_in' : settings.showDay}\">{{day}}, {{date}} {{month}}</div>\n    </div>\n</template>\n\n<script>\n    const monthArr = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep','Oct','Nov', 'Dec'];\n    const dayArr = ['Sunday', 'Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday'];\n    export default {\n        data () {\n            return {\n                hrs : '',\n                min: '',\n                day: '',\n                date: '',\n                month: ''\n            }\n        },\n        props:['settings'],\n        created(){\n            this.updateDateTime();\n        },\n        mounted () {\n            setInterval(this.updateDateTime, 1000);\n        },\n        methods: {\n            updateDateTime () {\n                let current = new Date();\n                this.hrs = current.getHours();\n                if(this.settings.showTwelveHour){\n                    this.hrs = this.hrs !== 0 ? this.hrs % 12 : 12;\n                }\n                this.hrs = this.getZeroPad(this.hrs);\n                this.min = this.getZeroPad(current.getMinutes());\n                this.day = dayArr[current.getDay()];\n                this.date = current.getDate();\n                this.month = monthArr[current.getMonth()];\n            },\n            getZeroPad (n) {\n                return (parseInt(n, 10) >= 10 ? '' : '0') + n\n            },\n            concatAMPM () {\n                if(this.settings.showTwelveHour) {\n                    return this.hours >= 12 ? 'PM' : 'AM'\n                }\n            }\n        }\n    }\n</script>\n<style>\n    .time, .date{\n        color: rgba(242, 242, 242, 0.9);\n    }\n    .time{\n        font-size: 12rem;\n        font-weight: 500;\n        line-height: 12rem;\n    }\n    .date{\n        opacity: 0;\n        font-size: 3.5rem;\n        font-weight: 900;\n        line-height: 4rem;\n        text-align: center;\n    }\n</style>"],"sourceRoot":"webpack://"}]);
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;
  return _h('div', {
    ...
    staticClass: "lever"
  }), "\n                    Show\n                "])])])]), "\n    " + _vm._s(_vm.settings.showUtilities) + "\n"])
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-65184dfb!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./clock.vue", function() {
			var newContent = require("!!./../../node_modules/css-loader/index.js?sourceMap!./../../node_modules/vue-loader/lib/style-rewriter.js?id=data-v-65184dfb!./../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./clock.vue");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
